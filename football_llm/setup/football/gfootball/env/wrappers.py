...
class Simple115StateWrapper_ball_owned_player(gym.ObservationWrapper):
  """A wrapper that converts an observation to 115-features state."""
  ...
  def observation(self, observation):
    """Converts an observation into simple115 (or simple115v2) format."""
    return Simple115StateWrapper_ball_owned_player.convert_observation(observation, self._fixed_positions)
