...
class DiscreteMeanQFunction(DiscreteQFunction):
    ...
    def __init__(self, encoder: Encoder, hidden_size: int, action_size: int):
        ...
        # self.encoder_factory = (hidden_units=[int(hidden_size/2), int(hidden_size/2), 1], activation='relu')
        # self.final_layer_decoder = []
        # self.action_size = action_size
        # for i in range(action_size):
        #     self.final_layer_decoder.append(self.encoder_factory.create(hidden_size))
