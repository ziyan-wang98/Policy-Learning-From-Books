...
groups_of_memory_patterns = [
    goal_keeper_far_pattern,        # Safe defensive pattern.
    goalkeeper_memory_patterns,     # Goalkeeper in possession.
    # special_spot_shot,      # Shot pattern was ineffective.
    special_game_modes_memory_patterns,     # Special game mode.
    ball_distance_2_5,
    ball_distance_close,
    # own_goal,
    # offence_memory_patterns,        # Own-team possession pattern was ineffective.
